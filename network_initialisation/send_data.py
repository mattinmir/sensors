...
if value != '08280B80':
    ...
    r = requests.post('http://api.smartlandlords.co.uk/api.php/data/', data = {"auth":"YWRtaW46Z2lyYWZmZXM=","data":[{"sensorID":sensor_id, "timestamp":timestamp, "value":str(decoded_value)}]})
